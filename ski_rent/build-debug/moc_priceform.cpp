...
#define QT_MOC_LITERAL(idx, ofs, len) \
    ...
    qptrdiff(offsetof(qt_meta_stringdata_PriceForm_t, stringdata) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_PriceForm_t qt_meta_stringdata_PriceForm = {
    {
QT_MOC_LITERAL(0, 0, 9) // "PriceForm"
...
const QMetaObject PriceForm::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_PriceForm.data,
      qt_meta_data_PriceForm,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *PriceForm::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_PriceForm.stringdata))
        return static_cast<void*>(const_cast< PriceForm*>(this));
